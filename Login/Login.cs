...
namespace Cookies_Loader_Base
{
    public partial class Login : Form
    {
        ...
        Uri sounds = new Uri("https://cdn.discordapp.com/attachments/1074004276466159717/1074004322284744795/NTS.wav");
        string file_sound = Path.GetTempPath() + "NTS.wav";
        #endregion
        ...
        private void LoginBtn_Click(object sender, EventArgs e)
        {
            if (username.Text == "")
            {
                MessageBox.Show("Please check if your username or password has been entered", "Login Error");
            }
            else
            {
                ...
                if (KeyAuthApp.response.success)
                {
                    MessageBox.Show("Welcome " + username.Text + " To Overtime Loader", "Login Success");
                    Home main = new Home();
                    main.Show();
                    this.Hide();
                }
                ...
                {
                    MessageBox.Show("Please check if the username or password is correct", "Login Error ");
                }
            }
