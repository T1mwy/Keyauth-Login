...
namespace Cookies_Loader_Base
{
    public partial class Register : Form
    {
        ...
        #region Already have an account label
        ...
        private void RgstrBtn_Click(object sender, EventArgs e)
        {
            if (username.Text == "")
            {
                MessageBox.Show("Please check if your username or password has been entered", "Register Error");
            }
            else
            {
                ...
                if (KeyAuthApp.response.success)
                {
                    MessageBox.Show("Please remember your username and password", "Register Success");
                    Home main = new Home();
                    main.Show();
                    this.Hide();
                }
                ...
                {
                    MessageBox.Show("Please check if the username or password is correct", "Register Error ");
                }
            }
        }
    }
